...
namespace MadLibs
{
  class Program
  {
    ...
    {
      /*
      This program receives user input for placement in a generated MadLibs story
      Author: Garrett Skinner
      */


      // Let the user know that the program is starting:
      Console.WriteLine("Welcome to Mad Lib generator!");

      // Give the Mad Lib a title:
      string title = "Super Crazy Mad Lib";
