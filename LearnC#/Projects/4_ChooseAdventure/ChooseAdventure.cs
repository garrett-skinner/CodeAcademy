      ...
      static void Main(string[] args)
    {
      ...
      if (noiseChoice == "NO") {
        ...
        if (doorChoice == "KNOCK") {
          ...
          Console.WriteLine("\"Poor people have it. Rich people need it. If you eat it you die.");
          ...
          switch (keyChoice) {
            ...
            case "3":
              ...
              break;
            default:
              Console.WriteLine("I don't have intructions for this case.  Whoops!");
              Console.WriteLine("That's awkward.  THE END (I guess?)");
              break;
          }
        }
      }
